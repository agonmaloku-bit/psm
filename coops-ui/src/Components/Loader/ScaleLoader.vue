...
<script>
// Local copy of vue-spinner/src/ScaleLoader.vue with the invalid `},` keyframe
// separators removed (the upstream package is unmaintained and ships a CSS
// syntax error that esbuild warns about on every build).
export default {
  name: 'ScaleLoader',
