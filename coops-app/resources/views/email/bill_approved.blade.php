...
@section('content')
<p style="font-size: 15px; font-weight: 700; color: #222; margin: 0 0 10px;">Bill has been approved by {{ $name }}</p>

<p style="font-size: 14px; color: #555; margin: 0 0 20px;">A bill you are involved in has been approved at the current workflow step.</p>
...
<table role="presentation" border="0" cellpadding="0" cellspacing="0" style="width: 100%; border-collapse: collapse; margin-bottom: 20px;">
    ...
    <tr>
        <td style="padding: 8px 0; font-size: 13px; color: #888;">Supplier</td>
        <td style="padding: 8px 0; font-size: 14px; color: #333;">{{ optional($bill->supplierName)->name ?? '-' }}</td>
    </tr>
</table>
