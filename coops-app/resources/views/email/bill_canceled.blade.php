...
@section('content')
<p style="font-size: 15px; font-weight: 700; color: #c0392b; margin: 0 0 10px;">Bill has been canceled by {{ $name }}</p>

<p style="font-size: 14px; color: #555; margin: 0 0 20px;">A bill you created has been canceled.</p>
