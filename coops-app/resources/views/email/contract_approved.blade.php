...
@section('content')
<p style="font-size: 15px; font-weight: 700; color: #222; margin: 0 0 10px;">Contract has been approved by {{ $name }}</p>

<p style="font-size: 14px; color: #555; margin: 0 0 20px;">A contract you are involved in has been approved at the current workflow step.</p>
