...
class CompanyMediator implements CompanyMediatorInterface
{
    ...
    {
        if (!Permission::hasPermissionTo([Permissions::COMPANY_SHOW, Permissions::CONTRACT_REQUEST, Permissions::CONTRACT_APPROVE]))
        {
    ...
    public function findbyId($id)
    {
        ...
        return ResponseResource::make($this->companyRepository->findById($id));
    }
    ...
    public function storeCompany($request)
    {
        ...
        $data = $request->only('name', 'business_no', 'address');
        ...
        return ResponseResource::make($this->companyRepository->store($data));
    }
