...
class ContractRequestRequest extends FormRequest
{
    /**
...
//            'name' => 'required|unique:contracts,name',
            ...
            // 'purpose_contractor' => ['required', 'string', 'max:255'],
//            'company_id' => ['required', 'numeric', 'exists:companies,id'],
            ...
            'responsible_person' => ['required', 'numeric'],
            ...
            // 'contractor_obligations' => ['required', 'string', 'max:1000'],
            // 'company_obligations' => ['required', 'string', 'max:1000'],
